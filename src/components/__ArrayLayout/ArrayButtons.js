...
const ArrayButton = ({icon, title, color="primary", variant="outlined", size="large", ...props}) => {
...
const ArrayButtons = ({className, spacing = 1, buttons = []}) => {

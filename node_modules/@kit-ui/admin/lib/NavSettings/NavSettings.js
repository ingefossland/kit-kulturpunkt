...
var _ListSettings = _interopRequireDefault(require("./ListSettings"));
...
var templates = {
  "list": _ListSettings.default,
  "grid": _GridSettings.default
};
...
var NavSettings = function NavSettings(_ref) {
  ...
  var renderSettings = function renderSettings(_ref2, index) {
    ...
    if (template && typeof template === "function") {
      ...
      SettingsTemplate = _ListSettings.default;
    }

    return /*#__PURE__*/_react.default.createElement(SettingsTemplate, _extends({}, props, {
      key: index
    }));
  };

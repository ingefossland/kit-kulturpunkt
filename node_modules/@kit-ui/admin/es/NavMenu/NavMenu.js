...
var NavMenuCalendar = function NavMenuCalendar() {
  return /*#__PURE__*/React.createElement("p", null, "cal");
};
...
var NavMenu = function NavMenu(_ref) {
  ...
  var renderLabel = function renderLabel(item) {
    var selected = item.selected,
        ...
        label = item.label,
        count = item.count;
    return /*#__PURE__*/React.createElement(NavMenuLabel, {
      selected: selected,
      url: url,
      icon: icon,
      label: label || title,
  ...
  var renderItem = function renderItem(item, index) {
    ...
    if (role === "section") {
      return /*#__PURE__*/React.createElement(NavMenuItem, {
        key: index,
        role: "group"
      }, renderLabel(item), children && /*#__PURE__*/React.createElement(NavMenuList, {
        role: "group"

...
var FieldMedia = /*#__PURE__*/function (_Component) {
  ...
  function FieldMedia() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (formData) {
      ...
      formData = (0, _utils.getDefaultFormState)(schema, _extends({}, defaultFormData, formData));
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react.default.createElement(ObjectField, _extends({}, this.props, {
      schema: schema,
      uiSchema: uiSchema,
      formData: formData,

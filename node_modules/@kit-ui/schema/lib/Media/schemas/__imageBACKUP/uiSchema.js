...
var _uiPreview = _interopRequireDefault(require("./uiPreview"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = {
  "ui:field": "pageEditor",
  "ui:preview": _uiPreview.default,
  "ui:fieldset": ["content", "settings"],
  "settings": {
    "ui:fieldset": ["upload", "metadata"],
    "ui:options": {
      "grid": true
    },
    "upload": {
      "ui:gridCols": 6,
      "ui:title": "Upload",
      "ui:field": "mediaEditorUpload",
      "ui:fieldset": ["uniqueId"]
    },
    "metadata": {
      "ui:gridCols": 6,
      "ui:fieldset": ["title", "uniqueId"]
    }
  },
  "content": {
    "ui:field": "pageContent",
    "ui:nav": true,
    "ui:fieldset": ["image", "metadata", "rights", "iptcdata", "exifdata"],
    "iptcdata": {
      "ui:layout": "section",
      "ui:title": "IPTC"
    },
    ...
    "image": {
      ...
      "ui:icon": "image",
      "ui:title": "Bilde",
      "ui:fieldset": ["title", "headline", "description", "descriptionWriter", "creditLine", "category", "keywords"],
      "title": {
        "ui:title": "Tittel",
    ...
    "rights": {
      ...
      "ui:fieldset": ["creator", "creatorJobtitle", "creatorContactInfo", "copyrightNotice", "copyrightOwner"],
      "creator": {

...
var MediaLayout = function MediaLayout(_ref) {
  var mediaId = _ref.mediaId,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["mediaId", "media", "minWidth", "minHeight", "backgroundColor", "color", "upload", "uploadProgress", "menu", "buttons", "children"]);
  ...
  var MediaHeader = function MediaHeader(_ref2) {
    var menu = _ref2.menu,
  ...
  if (uploadProgress && uploadProgress < 100) {
    ...
    }, /*#__PURE__*/_react.default.createElement(MediaHeader, props), /*#__PURE__*/_react.default.createElement(_admin.MediaUpload, _extends({}, props, {
      mediaType: mediaType,
  ...
  if (!mediaId && buttons) {
    return /*#__PURE__*/_react.default.createElement("div", {
      className: classes.media
    }, /*#__PURE__*/_react.default.createElement(_MediaButtons.default, {
      buttons: buttons
    }));
  }
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: classes.media
  }, /*#__PURE__*/_react.default.createElement(MediaHeader, _extends({}, props, {
    menu: menu
  })), children);
};

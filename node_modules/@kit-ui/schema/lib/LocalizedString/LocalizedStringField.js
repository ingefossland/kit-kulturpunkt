...
var LocalizedStringField = function LocalizedStringField(props) {
  ...
  var getUiSchema = function getUiSchema() {
    ...
    Object.keys(schema.properties).map(function (name) {
      ...
      var endAdornment = /*#__PURE__*/_react.default.createElement(_LocalizedStringSettings.default, props);

      localizedUiSchema[name] = _extends({}, uiSchema, {
        "ui:field": undefined,
        "ui:options": {
  ...
  var newUiOptions = (0, _utils.getUiOptions)(newUiSchema);
  return /*#__PURE__*/_react.default.createElement(_SchemaFieldset.default, _extends({}, props, {
    uiSchema: newUiSchema,
    fieldset: newUiOptions.fieldset
  }));

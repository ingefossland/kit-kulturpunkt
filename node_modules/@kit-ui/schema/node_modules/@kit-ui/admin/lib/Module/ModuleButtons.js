...
var ModuleButton = function ModuleButton(_ref) {
  var icon = _ref.icon,
      title = _ref.title,
...
var ModuleButtons = function ModuleButtons(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(_ButtonGroup.default, {
    ...
    return /*#__PURE__*/_react.default.createElement(ModuleButton, _extends({}, button, {
      className: classes.button,
      key: index
    }));
  }));

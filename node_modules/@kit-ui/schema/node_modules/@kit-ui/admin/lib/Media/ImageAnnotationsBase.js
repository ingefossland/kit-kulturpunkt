...
var _ImageAnnotationsMarkerDefault = _interopRequireDefault(require("./ImageAnnotationsMarkerDefault"));
...
var ImageAnnotations = function ImageAnnotations(_ref) {
  ...
  var handleClick = function handleClick(event) {
    var point = (0, _getImagePoint.getImagePointEvent)(event);
    setIsDragging(false);
    var newFormData;
  ...
  if (markerTemplate) {
    ...
    MarkerTemplate = _ImageAnnotationsMarkerDefault.default;
  }

  var classes = useStyles();
  var MarkerList = (0, _reactResizeDetector.withResizeDetector)(function (_ref3) {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      if (!onChange) {
        return /*#__PURE__*/_react.default.createElement(MarkerTemplate, _extends({}, marker, {
          index: index,
          key: index,
          position: {
            x: x,
  ...
  return /*#__PURE__*/_react.default.createElement(_ImageBase.default, _extends({
    ...
    onLoad: handleLoad
  }), /*#__PURE__*/_react.default.createElement(MarkerList, null));
};

var _default = ImageAnnotations;

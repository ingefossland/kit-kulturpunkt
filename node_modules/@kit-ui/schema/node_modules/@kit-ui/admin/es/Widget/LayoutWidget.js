...
import { Widget, LayoutWidgetHeader, NavSettings, NavAction, Button } from "../";
  ...
  function LayoutWidget() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSettings", function () {
      ...
      if (editable || expanded && settings) {
        return /*#__PURE__*/React.createElement(NavSettings, {
          settings: settings
        });
      }
    });
  ...
  _proto.render = function render() {
    ...
    if (editable && editing) {
      return /*#__PURE__*/React.createElement(Widget, {
        ...
        expanded: true,
        style: style
      }, /*#__PURE__*/React.createElement(NavAction, {
    ...
    if (expanded) {
      return /*#__PURE__*/React.createElement(Widget, {
        ...
        expanded: true,
        style: style
      }, /*#__PURE__*/React.createElement(NavSettings, {
        settings: settings
      }), this.props.children);
    }
    ...
    if (addable) {
      return /*#__PURE__*/React.createElement(Widget, {
        ...
        onClick: this.onAdd,
        style: style
      }, /*#__PURE__*/React.createElement(LayoutWidgetHeader, this.props), this.renderAdd());
    }
    ...
    return /*#__PURE__*/React.createElement(Widget, {
      ...
      expanded: false,
      style: style
    }, /*#__PURE__*/React.createElement(LayoutWidgetHeader, this.props));
  };

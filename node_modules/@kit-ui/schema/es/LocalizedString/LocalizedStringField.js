...
var LocalizedStringField = function LocalizedStringField(props) {
  ...
  var getUiSchema = function getUiSchema() {
    ...
    Object.keys(schema.properties).map(function (name) {
      ...
      var endAdornment = /*#__PURE__*/React.createElement(LocalizedStringSettings, props);
  ...
  var newUiOptions = getUiOptions(newUiSchema);
  return /*#__PURE__*/React.createElement(SchemaFieldset, _extends({}, props, {

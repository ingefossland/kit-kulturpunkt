...
export default {
  ...
  "content": {
    ...
    "ui:nav": true,
    "ui:fieldset": ["video", "metadata", "rights"],
    "video": {
      "ui:layout": "section",
      "ui:icon": "movie",
      "ui:title": "Video",
      "ui:fieldset": ["title", "headline", "description", "descriptionWriter", "creditLine", "volume", "category", "keywords"],
      "title": {
        "ui:title": "Tittel",
    ...
    "metadata": {
      ...
      "ui:icon": "tag",
      "ui:title": "Metadata",
      "ui:fieldset": ["category", "director", "producer", "series", "season", "episode", "locationShot", "locationShown", "album", "artist", "composer", "copywriter", "releaseYear", "recordCompany", "catalogNumber"],
      "title": {
        "ui:title": "Tittel",
    ...
    "rights": {
      ...
      "ui:fieldset": ["creator", "creatorJobtitle", "creditLine", "copyrightNotice", "copyrightOwner"],
      "creator": {

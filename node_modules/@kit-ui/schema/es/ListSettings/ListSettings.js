...
var ListSettings = function ListSettings(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ListSettingsButton, {
    onClick: _onToggle,
    icon: icon,
    ref: anchorRef
  ...
  }, /*#__PURE__*/React.createElement(ListSettingsOptions, {
    options: options,
    value: value,
    onChange: _onChange
  })));
